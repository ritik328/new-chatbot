      ...
      <div className="flex-1 overflow-y-auto relative">
        ...
        {!isSidebarOpen && (
          <button
            ...
            title="Open Sidebar"
            className="fixed top-4 left-4 p-2 text-white/40 hover:text-white hover:bg-white/10 rounded-lg transition-colors z-50"
          >
            ...
            <div className="flex items-center justify-between px-3 pb-3 pt-1 gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 px-2.5 h-8 rounded-lg text-xs font-mono transition-all border
                              ${searchEnabled 
                                ? 'bg-white/10 text-white border-white/20 hover:bg-white/15' 
                                : 'text-white/40 border-transparent hover:text-white/70 hover:bg-white/5 hover:border-white/10'}`}
                >
                  <span className={`w-1.5 h-1.5 rounded-full ${searchEnabled ? 'bg-green-400' : 'bg-white/30'}`} />
                  Web Search
                </button>
